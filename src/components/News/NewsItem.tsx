...
const NewsItem: React.FC<NewsProps> = ({ news }) => {
  const dateObj: Date = new Date(news.createdAt);
  const formattedDate: string = `${dateObj.getDate()} ${dateObj.toLocaleString("en-US", { month: "long" })}, ${dateObj.getFullYear()}`;
